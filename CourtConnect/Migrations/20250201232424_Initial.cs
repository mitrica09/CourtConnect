    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncesStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnounceStatusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Announces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Announces_AnnouncesStatus_AnnounceStatusId",
                        column: x => x.AnnounceStatusId,
                        principalTable: "AnnouncesStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Announces_Courts_CourtId",
                        column: x => x.CourtId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SetsResult", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SetsResult_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SetsResult_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SetsResult_Sets_SetId",
                        column: x => x.SetId,
                        principalTable: "Sets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announces_AnnounceStatusId",
                table: "Announces",
                column: "AnnounceStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Announces_CourtId",
                table: "Announces",
                column: "CourtId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SetsResult_MatchId",
                table: "SetsResult",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_SetsResult_SetId",
                table: "SetsResult",
                column: "SetId");

            migrationBuilder.CreateIndex(
                name: "IX_SetsResult_UserId",
                table: "SetsResult",
                column: "UserId");
